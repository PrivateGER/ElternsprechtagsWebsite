        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="/home"><button class="centered mx-auto" style="width: 100%">Zurück</button></a>
                                ...
                                @foreach ($period as $dt)
                                    @foreach($lehrerTimeTable as $time)
                                        ...
                                        @else
                                            ...
                                            @else
                                                    <li class='list-group-item'><?=$dt->format("H:i\n")?><button class="right_button button_space" onclick="requestDate('{{ $dt->format("Y-m-d H:i:s") }}')">Anfragen</button><p class="right_button ">Es sind schon {{ $requestCount }} Anfrage(n) für diese Zeit vorhanden!</p></li>
                                            @endif
                                        @endif
                                    @endforeach
                                @endforeach
